...
class visual(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "visual")
        ...
        self.settings = Qt.QSettings("GNU Radio", "visual")
...
def main(top_block_cls=visual, options=None):
