...
def probability_cal(selected_Pts_interest, selected_predictions, NUMBER):
	...
	for i in range(NUMBER):
		...
		# value = np.logical_xor(selected_Pts_interest[i], j)
		# probabilities = selected_predictions[i][v for v in value pass]
...
if __name__ == "__main__":
	...
	# 110 points
	model_path = './models/byte' + str(byteOfInterest) + '/attack_model_byte' + str(byteOfInterest) + '-' + str(epoch) + '.h5'
